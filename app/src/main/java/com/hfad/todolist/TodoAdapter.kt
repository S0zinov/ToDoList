...
class TodoAdapter(private val context: Context, val listener: TodoClickListener):
    ...
    override fun onBindViewHolder(holder: TodoAdapter.TodoViewHolder, position: Int) {
        ...
        when(item.priority){
            1 -> holder.title.setBackgroundColor(Color.parseColor("#FF0000"))
            2 -> holder.title.setBackgroundColor(Color.parseColor("#FFA500"))
            else -> holder.title.setBackgroundColor(Color.parseColor("#008000"))
        }
    ...
    inner class TodoViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        val fio = itemView.findViewById<TextView>(R.id.tv_fio)
    }
